...
function CreateSlideClientComponent() {
  ...
  const handleAddSlide = async (e) => {
    ...
    if (!finalImageUrl) {
      toast.error('An image is required for the slide.');
      return;
    }
  ...
  return (
    <div className="admin-settings-container">
      <h3>Add New Slide</h3>
      <form onSubmit={handleAddSlide} className="settings-form">
...
export default CreateSlideClientComponent;
